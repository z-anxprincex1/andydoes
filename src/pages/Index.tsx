...
const Index = () => {
  ...
  return <main className="fixed inset-0 flex items-center bg-background overflow-hidden" ref={containerRef}>
      ...
      <div className={`w-full px-6 md:px-12 lg:px-20 relative z-10 flex flex-col items-center justify-center gap-8 md:gap-12 lg:gap-16 -mt-16 md:mt-0 ${isGeneratorOn ? 'animate-whoosh-up pointer-events-none' : wasGeneratorOn ? 'animate-slide-down-in' : ''}`}>
